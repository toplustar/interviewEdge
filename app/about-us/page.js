...
const AboutUsPage = () => {
  ...
  const tabContent = {
    mission: {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">InterviewEdge is on a mission to revolutionize interview preparation by providing personalized, intelligent AI coaching tailored to individual career aspirations.</p>
          <p className="text-base md:text-lg">With InterviewEdge, the goal is to bridge the gap between preparation and success, empowering users to unlock their full potential.</p>
        </div>
      )
    },
    story: {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">The idea for InterviewEdge was born from firsthand experiences with the challenges of interview preparation. As a solo developer, I wanted to create a platform that simplifies the process and builds confidence in individuals.</p>
    ...
    approach: {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">InterviewEdge leverages advanced AI algorithms to generate dynamic, contextually relevant interview questions based on your professional background and goals.</p>
